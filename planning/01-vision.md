...
skills/             ← 116 skill files (read by commands when needed)
...
- Agent Skills specification compliance — all 116 SKILL.md files prefixed with `dotnet-ai-`
